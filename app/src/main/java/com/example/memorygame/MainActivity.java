...
public class MainActivity extends AppCompatActivity {
    ...
    protected void Animate(ImageView view){
        ...
        oa1.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                View.setImageResource(R.drawable.mark);
                oa2.start();
            }
        });
        oa1.start();
    ...
    protected void compare(){
        ...
        {
            chronometer.stop();
            AlertDialog.Builder end = new AlertDialog.Builder(MainActivity.this);
            end.setMessage("YOU WON!");
            end.setCancelable(false);
            end.setPositiveButton("New Game", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    restart.performClick();
                }
            });
            end.setNegativeButton("Exit", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    finish();
                }
    ...
    protected void ChangeImage(ImageView view,int tag){
        if(array[tag]==1)
        {
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.gryffindor);
                    oa2.start();
                }
            });
            oa1.start();

            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.gryffindor);
            myMediaPlayer.start();
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.slytherin);
                    oa2.start();
                }
            });
            oa1.start();
            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.slytherin);
            myMediaPlayer.start();
        }
        else if(array[tag]==3){
            final ObjectAnimator oa1 = ObjectAnimator.ofFloat(view, "scaleX", 1f, 0f);
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.ravenclaw);
                    oa2.start();
                }
            });
            oa1.start();
            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.ravenclaw);
            myMediaPlayer.start();
        }
        else if(array[tag]==4){
            final ObjectAnimator oa1 = ObjectAnimator.ofFloat(view, "scaleX", 1f, 0f);
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.huffelpuf);
                    oa2.start();
                }
            });
            oa1.start();
            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.huffelpuff);
            myMediaPlayer.start();
        }
        else if(array[tag]==5){
            final ObjectAnimator oa1 = ObjectAnimator.ofFloat(view, "scaleX", 1f, 0f);
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.hogwarts);
                    oa2.start();
                }
            });
            oa1.start();
            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.hogwarts);
            myMediaPlayer.start();
        }
        else if(array[tag]==6){
            final ObjectAnimator oa1 = ObjectAnimator.ofFloat(view, "scaleX", 1f, 0f);
            ...
            oa1.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    View.setImageResource(R.drawable.hp);
                    oa2.start();
                }
            });
            oa1.start();
            myMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.harrypotter);
            myMediaPlayer.start();
        }
            if(number==1)
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restart.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                Collections.shuffle(list);
                list.toArray(array);
                image1.setImageResource(R.drawable.mark);
                image2.setImageResource(R.drawable.mark);
                image3.setImageResource(R.drawable.mark);
                image4.setImageResource(R.drawable.mark);
                image5.setImageResource(R.drawable.mark);
                image6.setImageResource(R.drawable.mark);
                image7.setImageResource(R.drawable.mark);
                image8.setImageResource(R.drawable.mark);
                image9.setImageResource(R.drawable.mark);
                image10.setImageResource(R.drawable.mark);
                image11.setImageResource(R.drawable.mark);
                image12.setImageResource(R.drawable.mark);
